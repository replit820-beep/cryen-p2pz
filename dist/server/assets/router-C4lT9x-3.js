...
const appCss = "/assets/styles-ConwQv-v.css";
...
const Disc3 = createLucideIcon("disc-3", __iconNode$8);
const __iconNode$7 = [
...
function TopHeader() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "sticky top-0 z-30 glass-strong border-b border-primary/30", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-4 py-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "tap rounded-xl px-2 py-1.5 flex items-center gap-1.5 bg-white/5 border border-white/10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Globe, { className: "size-4 text-primary" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold", children: "EN" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex flex-col items-center -mt-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Crown, { className: "size-3.5 text-gold -mb-1", style: { color: "oklch(0.85 0.16 85)" } }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-extrabold tracking-widest text-[15px] text-glow-blue", children: "JAI CLUB" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "tap relative size-9 rounded-xl bg-white/5 border border-white/10 grid place-items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Bell, { className: "size-4" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -top-1 -right-1 size-4 rounded-full bg-red-bet text-[9px] font-bold grid place-items-center", style: { background: "oklch(0.65 0.24 27)" }, children: "3" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/wallet", className: "tap size-9 rounded-xl bg-grad-primary grid place-items-center glow", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Wallet, { className: "size-4" }) })
    ] })
  ] }) });
}
const tabs = [
...
function BottomNav() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "absolute bottom-0 left-0 right-0 z-30", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "glass-strong rounded-t-3xl border-t border-primary/40 px-2 pt-2 pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-end justify-between", children: tabs.map(({ to, label, icon: Icon2, center }) => {
    const active = loc.pathname === to;
    if (center) {
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to, className: "-mt-7 tap", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `size-14 rounded-2xl bg-grad-primary grid place-items-center glow ${active ? "animate-pulse-glow" : ""}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "size-6" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-center mt-1 font-medium", children: label })
      ] }, to);
    }
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to, className: "flex-1 flex flex-col items-center gap-1 py-1 tap", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: `size-5 ${active ? "text-primary text-glow" : "text-muted-foreground"}` }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-[10px] ${active ? "text-primary font-semibold" : "text-muted-foreground"}`, children: label })
    ] }, to);
  }) }) }) });
}
const actions = [
...
function FloatingActions() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute right-2.5 bottom-32 z-20 flex flex-col gap-2.5", children: actions.map(({ Icon: Icon2, color, label }, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    "button",
    {
...
function AppShell() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen w-full flex justify-center md:p-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full max-w-[420px] min-h-screen md:min-h-[900px] md:max-h-[900px] md:rounded-[2.2rem] overflow-hidden bg-background shadow-card border border-white/5 flex flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-none absolute -top-24 -left-20 w-72 h-72 rounded-full bg-primary/30 blur-3xl" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-none absolute top-40 -right-24 w-72 h-72 rounded-full bg-pink/20 blur-3xl", style: { background: "oklch(0.62 0.25 320 / 0.25)" } }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-none absolute bottom-0 left-1/2 -translate-x-1/2 w-80 h-80 rounded-full bg-bluebet/20 blur-3xl", style: { background: "oklch(0.5 0.2 270 / 0.25)" } }),
    !hide && /* @__PURE__ */ jsxRuntimeExports.jsx(TopHeader, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "relative flex-1 overflow-y-auto scrollbar-none pb-28 animate-fade-in", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) }),
    !hide && /* @__PURE__ */ jsxRuntimeExports.jsx(FloatingActions, {}),
    !hide && /* @__PURE__ */ jsxRuntimeExports.jsx(BottomNav, {})
  ] }) });
}
...
const Route$c = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { title: "JAI CLUB — Color Trading & WinGo" },
      { name: "description", content: "Premium neon casino color prediction & WinGo gaming app." },
      { name: "theme-color", content: "#0f1020" },
      { property: "og:title", content: "JAI CLUB — Color Trading" },
      { property: "og:description", content: "Premium neon casino color prediction & WinGo gaming app." },
...
const $$splitComponentImporter$b = () => import("./withdraw-DA0DojT7.js");
const Route$b = createFileRoute("/withdraw")({
  component: lazyRouteComponent($$splitComponentImporter$b, "component")
});
const $$splitComponentImporter$a = () => import("./wingo-CgsI6jO8.js");
const Route$a = createFileRoute("/wingo")({
  component: lazyRouteComponent($$splitComponentImporter$a, "component")
});
const $$splitComponentImporter$9 = () => import("./wallet-BiSBSHPG.js");
const Route$9 = createFileRoute("/wallet")({
  component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
const $$splitComponentImporter$8 = () => import("./vip-YxHanOjE.js");
const Route$8 = createFileRoute("/vip")({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./register-DofXgqsf.js");
const Route$7 = createFileRoute("/register")({
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./promotion-FzWaI5qm.js");
const Route$6 = createFileRoute("/promotion")({
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./login-CK8TRP4I.js");
const Route$5 = createFileRoute("/login")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./deposit-DfVuTfY4.js");
const Route$4 = createFileRoute("/deposit")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./aviator-BiVeiw3t.js");
const Route$3 = createFileRoute("/aviator")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./activity-C2l4zvqe.js");
const Route$2 = createFileRoute("/activity")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./account-k97W28Hs.js");
const Route$1 = createFileRoute("/account")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./index-CBDwugSJ.js");
const Route2 = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const WithdrawRoute = Route$b.update({
  id: "/withdraw",
  path: "/withdraw",
  getParentRoute: () => Route$c
});
const WingoRoute = Route$a.update({
  id: "/wingo",
  path: "/wingo",
  getParentRoute: () => Route$c
});
const WalletRoute = Route$9.update({
  id: "/wallet",
  path: "/wallet",
  getParentRoute: () => Route$c
});
const VipRoute = Route$8.update({
  id: "/vip",
  path: "/vip",
  getParentRoute: () => Route$c
});
...
const PromotionRoute = Route$6.update({
  id: "/promotion",
  path: "/promotion",
  getParentRoute: () => Route$c
});
...
const DepositRoute = Route$4.update({
  id: "/deposit",
  path: "/deposit",
  getParentRoute: () => Route$c
});
const AviatorRoute = Route$3.update({
  id: "/aviator",
  path: "/aviator",
  getParentRoute: () => Route$c
});
