import { $ as commonjsGlobal, a0 as getDefaultExportFromCjs, r as reactExports, S as React, T as jsxRuntimeExports } from "./server-DCz9Nw-t.js";
import { C as Clock, X } from "./x-CkkHK2Kp.js";
...
const Frown = createLucideIcon("frown", __iconNode$1);
const __iconNode = [
...
function genResults(start, n) {
  const out = [];
  for (let i = 0; i < n; i++) {
    out.push({
      period: String(start - i),
      number: Math.floor(Math.random() * 10)
    });
  }
  return out;
}
const colorsOf = (n) => n === 0 ? ["red", "violet"] : n === 5 ? ["green", "violet"] : n % 2 === 0 ? ["red"] : ["green"];
const ballClass = (n) => {
...
function Ball({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `relative ${dim} shrink-0`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `absolute inset-0 rounded-full bg-gradient-to-br ${ballClass(n)} shadow-card border border-white/30` }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 rounded-full bg-gradient-to-br from-white/40 via-transparent to-transparent" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-[15%] rounded-full bg-white/95 grid place-items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `font-extrabold bg-gradient-to-br ${ballClass(n)} bg-clip-text text-transparent`, children: n }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-[10%] left-[20%] w-[28%] h-[18%] rounded-full bg-white/70 blur-[2px]" })
  ] });
}
function WinGo() {
  const [tab, setTab] = reactExports.useState(0);
  const [bottomTab, setBottomTab] = reactExports.useState("history");
  const [results, setResults] = reactExports.useState([]);
  reactExports.useEffect(() => {
    setResults(genResults(20260509100051884, 30));
  }, []);
  const [myBets, setMyBets] = reactExports.useState([]);
  const [secs, setSecs] = reactExports.useState(intervals[0].secs);
  const [pending, setPending] = reactExports.useState(null);
  const [activeBet, setActiveBet] = reactExports.useState(null);
  const [revealed, setRevealed] = reactExports.useState(null);
  const [outcome, setOutcome] = reactExports.useState(null);
  const periodRef = reactExports.useRef(results[0].period);
  reactExports.useEffect(() => {
  ...
  reactExports.useEffect(() => {
    ...
    if (sel.kind === "color") {
      label = sel.value;
      const cs = colorsOf(n);
      if (sel.value === "Green" && cs.includes("green")) {
        win = true;
        mult = cs.includes("violet") ? 1.5 : 2;
      }
      if (sel.value === "Red" && cs.includes("red")) {
        win = true;
        mult = cs.includes("violet") ? 1.5 : 2;
      }
      if (sel.value === "Violet" && cs.includes("violet")) {
        win = true;
        mult = 4.5;
      }
    } else if (sel.kind === "size") {
      label = sel.value;
      if (sel.value === "Big" && n >= 5 || sel.value === "Small" && n <= 4) {
        win = true;
        mult = 2;
      }
    ...
    setOutcome({
      status,
      amount: win ? payout : activeBet.amount,
      label,
      number: n,
      period: activeBet.period
    });
  ...
  const chartData = reactExports.useMemo(() => results.slice(0, 14).reverse().map((r2, i) => ({
    name: i,
    value: r2.number
  })), [results]);
  const currentPeriod = periodRef.current;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-3 pt-3 space-y-3 pb-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-4 gap-2", children: intervals.map((it, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setTab(i), className: `tap relative rounded-2xl py-3 transition-all ${tab === i ? "bg-gradient-to-br from-fuchsia-500/40 to-violet-600/40 border border-violet-400/60 glow" : "glass border border-white/10"}`, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `mx-auto mb-1 size-9 rounded-full grid place-items-center ${tab === i ? "bg-gradient-to-br from-violet-400 to-fuchsia-600 shadow-[0_0_18px_rgba(196,131,255,0.8)]" : "bg-white/10"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "size-4" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] font-bold leading-tight", children: "WinGo" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] opacity-90", children: it.short })
    ] }, it.short)) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative rounded-3xl p-[2px] bg-gradient-to-r from-pink-400 via-fuchsia-400 to-blue-400 shadow-card", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-3xl p-4 bg-gradient-to-r from-pink-500/30 via-fuchsia-500/30 to-blue-500/30 backdrop-blur-md flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "px-3 py-1 rounded-full bg-white/20 backdrop-blur text-[11px] font-semibold flex items-center gap-1 mb-2 border border-white/30", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CircleQuestionMark, { className: "size-3" }),
          " How to play"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs opacity-90", children: intervals[tab].label }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1 mt-2", children: results.slice(0, 5).map((r2) => /* @__PURE__ */ jsxRuntimeExports.jsx(Ball, { n: r2.number, size: "sm" }, r2.period)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] font-semibold", children: "Time remaining" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1 mt-1 justify-end", children: digits.map((d, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block size-7 rounded-md bg-black/80 grid place-items-center text-base font-extrabold border border-white/20", children: d }),
          i === 1 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "px-0.5 font-bold", children: ":" })
        ] }, i)) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] mt-1 font-mono", children: currentPeriod })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-2", children: [{
      t: "Green",
      grad: "from-emerald-400 to-emerald-600",
      shape: "rounded-l-2xl rounded-tr-2xl rounded-br-md"
    }, {
      t: "Violet",
      ...
      shape: "rounded-r-2xl rounded-tl-2xl rounded-bl-md"
    }].map((c2) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { disabled: !!activeBet, onClick: () => setPending({
      kind: "color",
      value: c2.t
    }), className: `tap relative bg-gradient-to-br ${c2.grad} ${c2.shape} py-3.5 font-extrabold text-base text-white shadow-card border border-white/20 disabled:opacity-50`, children: c2.t }, c2.t)) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-3xl bg-black/30 border border-white/10 p-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-5 gap-y-3 place-items-center", children: Array.from({
        length: 10
      }).map((_, n) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { disabled: !!activeBet, onClick: () => setPending({
        kind: "number",
        value: n
      }), className: "tap disabled:opacity-50", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Ball, { n, size: "lg" }) }, n)) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 flex items-center gap-1.5 justify-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "px-3 py-1.5 rounded-lg border border-rose-500/60 text-rose-300 text-[11px] font-bold", children: "Random" }),
        ["X1", "X5", "X10", "X20", "X50", "X100"].map((x2, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: `px-2.5 py-1.5 rounded-lg text-[11px] font-bold ${i === 0 ? "bg-emerald-500 text-white" : "bg-black/40 border border-white/10"}`, children: x2 }, x2))
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 flex rounded-full overflow-hidden shadow-card border border-white/10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { disabled: !!activeBet, onClick: () => setPending({
          kind: "size",
          value: "Big"
        }), className: "tap flex-1 py-3 bg-gradient-to-r from-orange-400 to-amber-500 font-extrabold text-white text-base disabled:opacity-50", children: "Big" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { disabled: !!activeBet, onClick: () => setPending({
          kind: "size",
          value: "Small"
        }), className: "tap flex-1 py-3 bg-gradient-to-r from-sky-500 to-blue-600 font-extrabold text-white text-base disabled:opacity-50", children: "Small" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2", children: [{
      ...
      l,
      I
    }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setBottomTab(k2), className: `flex-1 tap py-2.5 rounded-xl text-[12px] font-semibold flex items-center justify-center gap-1 border ${bottomTab === k2 ? "bg-gradient-to-r from-pink-400 via-fuchsia-400 to-blue-400 text-black border-white/30" : "glass text-muted-foreground border-white/10"}`, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(I, { className: "size-3.5" }),
      l
    ] }, k2)) }),
    bottomTab === "history" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl overflow-hidden border border-white/10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-[1.4fr_0.6fr_0.7fr_0.7fr] px-3 py-2.5 text-[11px] font-bold uppercase bg-violet-700/40", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Period" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center", children: "Number" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center", children: "Big Small" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center", children: "Color" })
      ] }),
      results.slice(0, 10).map((r2) => {
        const cs = colorsOf(r2.number);
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-[1.4fr_0.6fr_0.7fr_0.7fr] px-3 py-2.5 text-xs border-b border-white/5 items-center bg-black/20", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono text-[11px]", children: r2.period }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-2xl font-extrabold bg-gradient-to-br ${ballClass(r2.number)} bg-clip-text text-transparent`, children: r2.number }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center text-[11px] font-semibold", children: r2.number >= 5 ? "Big" : "Small" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center gap-1", children: cs.map((c2, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `size-2.5 rounded-full ${c2 === "red" ? "bg-red-500" : c2 === "green" ? "bg-emerald-500" : "bg-fuchsia-500"}` }, i)) })
        ] }, r2.period);
      }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-3 px-3 py-3 text-[12px]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "size-9 rounded-lg bg-violet-500 grid place-items-center font-bold", children: "‹" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", children: "3/50" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "size-9 rounded-lg bg-violet-500 grid place-items-center font-bold", children: "›" })
      ] })
    ] }),
    bottomTab === "chart" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "glass rounded-2xl p-3 h-56", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(LineChart, { data: chartData, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(XAxis, { dataKey: "name", stroke: "#a1a1c2", fontSize: 10 }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(YAxis, { stroke: "#a1a1c2", fontSize: 10, domain: [0, 9] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { contentStyle: {
        background: "#16162b",
        border: "1px solid #7b5cff",
        borderRadius: 12
      } }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Line, { type: "monotone", dataKey: "value", stroke: "#b89bff", strokeWidth: 2.5, dot: {
        fill: "#7b5cff",
        r: 4
      } })
    ] }) }) }),
    bottomTab === "mine" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
      myBets.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "glass rounded-2xl p-6 text-center text-xs text-muted-foreground", children: "No bets yet — place one above!" }),
      myBets.map((b, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass rounded-2xl p-3 flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs font-bold", children: [
            "Bet on ",
            b.label
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[10px] text-muted-foreground mt-0.5 font-mono", children: [
            b.period,
            " · ₹",
            b.amount
          ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-extrabold", style: {
            color: b.status === "Win" ? "#34d399" : "#f87171"
          }, children: b.status === "Win" ? `+₹${b.payout}` : `-₹${b.amount}` }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-muted-foreground", children: b.status })
        ] })
      ] }, i))
    ] }),
    pending && /* @__PURE__ */ jsxRuntimeExports.jsx(BetModal, { sel: pending, period: currentPeriod, onClose: () => setPending(null), onConfirm: (amount) => {
      setActiveBet({
        sel: pending,
        amount,
    ...
    revealed?.show && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-x-0 top-1/3 z-40 grid place-items-center pointer-events-none animate-pop-in", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-32 rounded-3xl bg-gradient-to-br from-violet-400 to-fuchsia-600 grid place-items-center text-7xl font-black text-white shadow-[0_0_60px_rgba(196,131,255,0.9)] border-4 border-white/30", children: revealed.number }) }) }),
    outcome && /* @__PURE__ */ jsxRuntimeExports.jsx(OutcomeModal, { outcome, onClose: () => setOutcome(null) })
  ] });
}
function BetModal({
  sel,
  ...
  const [balance, setBalance] = reactExports.useState(1);
  ...
  const headerColor = sel.kind === "color" ? sel.value === "Green" ? "from-emerald-400 to-emerald-600" : sel.value === "Red" ? "from-red-400 to-rose-600" : "from-violet-400 to-fuchsia-600" : sel.kind === "size" ? sel.value === "Big" ? "from-orange-400 to-amber-500" : "from-sky-500 to-blue-600" : "from-violet-400 to-fuchsia-600";
  const selectLabel = sel.kind === "color" ? sel.value : sel.kind === "size" ? sel.value : `Number ${sel.value}`;
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 flex items-end justify-center bg-black/60 backdrop-blur-sm animate-fade-in", onClick: onClose, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-md animate-slide-up", onClick: (e) => e.stopPropagation(), children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `bg-gradient-to-r ${headerColor} pt-4 pb-6 px-5 rounded-t-3xl text-center text-white relative`, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-bold opacity-95", children: interval }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 mx-auto bg-white text-black rounded-xl py-2.5 px-4 max-w-[260px] font-extrabold", children: [
        "Select ",
        selectLabel
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `absolute left-1/2 -translate-x-1/2 -bottom-3 w-10 h-6 bg-gradient-to-b ${headerColor}`, style: {
        clipPath: "polygon(0 0, 100% 0, 50% 100%)"
      } })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#1b1832] px-5 pt-6 pb-4 space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-bold text-base flex-1", children: "Balance" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1.5", children: [1, 10, 100, 1e3].map((b) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setBalance(b), className: `px-3 py-1.5 rounded-md text-xs font-bold ${balance === b ? "bg-orange-500 text-white" : "bg-violet-700/60"}`, children: b }, b)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-bold text-base flex-1", children: "Quantity" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setQty(Math.max(1, qty - 1)), className: "size-8 rounded-md bg-orange-500 grid place-items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Minus, { className: "size-4" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-14 text-center font-extrabold text-lg", children: qty }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setQty(qty + 1), className: "size-8 rounded-md bg-orange-500 grid place-items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "size-4" }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1.5 justify-end", children: [1, 5, 10, 20, 50, 100].map((m) => /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setMult(m), className: `px-2.5 py-1.5 rounded-md text-[11px] font-bold ${mult === m ? "bg-orange-500 text-white" : "bg-violet-700/60"}`, children: [
        "X",
        m
      ] }, m)) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setAgree(!agree), className: "flex items-center gap-2 text-xs", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `size-5 rounded-full grid place-items-center ${agree ? "bg-violet-500" : "border border-white/30"}`, children: agree && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white text-[10px]", children: "✓" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "I agree" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-rose-400", children: "《Pre-sale rules》" })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-[1fr_2fr] bg-[#1b1832]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: onClose, className: "py-4 bg-[#2b2545] font-bold", children: "Cancel" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { disabled: !agree, onClick: () => onConfirm(total), className: "py-4 bg-orange-500 font-extrabold text-white text-base disabled:opacity-50", children: [
        "Total amount ₹",
...
function OutcomeModal({
  ...
  reactExports.useEffect(() => {
    ...
    const t = setTimeout(() => setCount(count - 1), 1e3);
    return () => clearTimeout(t);
  }, [count, onClose]);
  const n = outcome.number ?? 0;
  const colorTag = n === 0 ? "Red+Violet" : n === 5 ? "Green+Violet" : n % 2 === 0 ? "Red" : "Green";
  const sizeTag = n >= 5 ? "Big" : "Small";
  const colorBadge = (c2) => c2.includes("Green") ? "bg-emerald-500" : c2.includes("Red") ? "bg-rose-500" : "bg-fuchsia-500";
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-[60] grid place-items-center bg-black/70 backdrop-blur-sm animate-fade-in p-4", onClick: onClose, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full max-w-[340px] animate-pop-in", onClick: (e) => e.stopPropagation(), children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-20 -mb-6 z-10 grid place-items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `absolute inset-x-1/2 -translate-x-1/2 top-0 size-16 rounded-full grid place-items-center shadow-[0_0_30px_rgba(255,180,80,0.8)] ${win ? "bg-gradient-to-br from-amber-300 to-orange-500" : "bg-gradient-to-br from-rose-400 to-rose-600"}`, children: win ? /* @__PURE__ */ jsxRuntimeExports.jsx(Rocket, { className: "size-7 text-white" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Frown, { className: "size-8 text-white" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-3 left-1/2 -translate-x-[58px] w-12 h-8 bg-gradient-to-l from-orange-300/80 to-transparent rounded-l-full blur-[1px]" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-3 left-1/2 translate-x-[10px] w-12 h-8 bg-gradient-to-r from-orange-300/80 to-transparent rounded-r-full blur-[1px]" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `rounded-3xl pt-12 pb-5 px-5 text-center text-white relative ${win ? "bg-gradient-to-b from-orange-400 via-orange-500 to-rose-500" : "bg-gradient-to-b from-rose-500 via-rose-600 to-rose-700"} shadow-2xl border-2 border-white/30`, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl font-black drop-shadow", children: win ? "Congratulations" : "Sorry" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 flex items-center justify-center gap-2 text-xs font-semibold", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "opacity-90", children: "Lottery results" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `px-2.5 py-1 rounded-md text-white text-[11px] font-bold ${colorBadge(colorTag.split("+")[0])}`, children: colorTag.split("+")[0] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "size-6 rounded-full bg-white text-orange-600 grid place-items-center text-xs font-black", children: n }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "px-2.5 py-1 rounded-md bg-emerald-500 text-white text-[11px] font-bold", children: sizeTag })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 bg-gradient-to-b from-white to-orange-50 text-orange-600 rounded-xl py-4 px-3 relative", style: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-bold text-rose-500", children: win ? "Bonus" : "Loss" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-black mt-1", children: win ? `₹${outcome.amount.toLocaleString()}` : `-₹${outcome.amount.toLocaleString()}` }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[10px] text-gray-500 mt-2 font-mono", children: [
          "Period: ",
          outcome.period ?? "—"
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: onClose, className: "mt-4 mx-auto flex items-center gap-2 text-xs", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "size-4 rounded-full border border-white/70 grid place-items-center text-[10px]", children: "○" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "opacity-95", children: [
          count,
          " seconds auto close"
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: onClose, className: "mt-4 mx-auto block size-11 rounded-full bg-white/10 border border-white/30 grid place-items-center backdrop-blur tap", children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "size-5 text-white" }) })
  ] }) });
}
export {
  WinGo as component
