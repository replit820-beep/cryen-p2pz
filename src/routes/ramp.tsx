...
function Ramp() {
  ...
  const [fiatCode, setFiatCode] = useState(params.fiat);
  const [cryptoSymbol, setCryptoSymbol] = useState(params.crypto);
    ...
    <main className="mx-auto min-h-screen w-full max-w-[430px] bg-white pb-20 shadow-[0_0_40px_-28px_oklch(0.25_0.04_265/0.35)]">
      ...
      {step === "quote" && tab !== "stocks" && (
        <div className="px-4 pt-5 animate-rise">
          <div className="rounded-lg border border-ramp-line bg-white p-4 transition-colors focus-within:border-ramp-primary">
            ...
            <div className="flex items-center justify-between gap-2">
              <input
                ...
                inputMode="decimal"
                 className="w-full min-w-0 bg-transparent text-[23px] font-semibold text-ink outline-none"
              />
              <button
                onClick={() => {
                 ...
                 className="flex shrink-0 items-center gap-1.5 rounded-lg bg-ramp-primary-soft px-2.5 py-2"
              >
                {tab === "buy" ? (
          ...
          <div className="mt-3 rounded-lg border border-ramp-line bg-white p-4">
            <p className="text-[11px] text-ink-soft">You Get</p>
            <div className="flex items-center justify-between gap-2">
              <p className="w-full min-w-0 truncate text-[24px] font-semibold text-ink">
                {tab === "buy"
          ...
          <div className="mt-4 space-y-2.5 rounded-lg bg-ramp-primary-soft p-4 text-[12px]">
          ...
          <button
            ...
            className="mt-6 flex h-12 w-full items-center justify-center gap-2 rounded-lg bg-ramp-primary text-[14px] font-semibold text-brand-foreground shadow-[0_8px_18px_-12px_var(--ramp-primary)] transition-opacity hover:opacity-90"
          >
      ...
      {step === "quote" && tab === "stocks" && (
        <div className="space-y-3 px-5 pt-5">
          {STOCKS.map((s) => (
            <div key={s.symbol} className="rounded-2xl bg-surface-soft p-4">
      ...
      {step === "wallet" && (
        <div className="px-4 animate-rise">
          <div className="rounded-lg bg-notice p-3 text-[12px] leading-relaxed text-ink">
          ...
          <button
            ...
            className="mt-2 flex h-14 w-full items-center justify-between rounded-xl border border-border px-4"
          >
          ...
          <div className="mt-2 flex h-14 items-center gap-2 rounded-xl border border-border px-4">
            <input
              value={address}
      ...
      {step === "review" && (
        <div className="px-4 animate-rise">
          ...
          <div className="mt-3 overflow-hidden rounded-xl bg-surface-soft">
          ...
          <div className="mt-4 rounded-lg bg-notice p-4">
          ...
          <button
            onClick={() =>
             ...
             className="mt-6 flex h-12 w-full items-center justify-center gap-2 rounded-lg bg-ramp-primary text-[14px] font-semibold text-brand-foreground"
          >
...
function FooterCta({
  ...
  return (
    <button
      onClick={onClick}
      disabled={disabled}
      className="mt-10 flex h-12 w-full items-center justify-center gap-2 rounded-lg bg-ramp-primary text-[14px] font-semibold text-brand-foreground disabled:bg-ramp-primary/25"
    >
